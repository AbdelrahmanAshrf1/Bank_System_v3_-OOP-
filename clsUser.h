...
private:
    ...
    static void _AddDataLineToFile(string  stDataLine , string UserFile = "Users.txt")
    {
        fstream MyFile;
...
public:
    ...
    enum enPermissions
    {
        ...
        pFindClient = 16, pTransactions = 32, pManageUsers = 64, eLoginRegister = 128, eCurrencyExchange = 256
    };
    ...
    void RegisterLogin()
    {
        ...
        fstream MyFile;
        MyFile.open("LoginRegister", ios::out | ios::app);

        if (MyFile.is_open())
        {
            cout << stDataLine << endl;
            MyFile.close();
        }
    }
